  ...
  return (
    <div>
      ...
      <div class="grid-container">
        <div>
          <Link to={`/spacegallery/astronomical/evenings/almajdwaebenseina`}>
        ...
        <div>
          <Link to={`/spacegallery/astronomical/evenings/omarbenalkhatab`}>
        ...
        <div>
          <Link to={`/spacegallery/astronomical/evenings/ajyalschool`}>
        ...
        <div>
          <Link to={`/spacegallery/astronomical/evenings/ebenroshdschool`}>
        ...
        <div>
          <Link to={`/spacegallery/astronomical/evenings/alshafeaeschool`}>
