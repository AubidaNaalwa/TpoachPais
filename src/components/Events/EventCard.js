        ...
        <div>
            ...
            <Link to={window.location.pathname === '/tpais/events' ? '/tpais/events/eventinfo' : '/space/events/eventinfo'}>
                <Card className={classes.root} onClick={() => setEvent(eInfo)}>
                    <CardActionArea>
                        <CardMedia>
                            <img className={classes.media} src={!err ? eInfo.img : "https://elearningindustry.com/wp-content/uploads/2020/01/designing-effective-elearning-courses.jpg"} onError={() => setErr(1)} />
                        </CardMedia>
                        <CardContent>
